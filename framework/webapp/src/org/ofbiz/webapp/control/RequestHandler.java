...
public class RequestHandler {
    ...
    public void doRequest(HttpServletRequest request, HttpServletResponse response, String requestUri) throws RequestHandlerException, RequestHandlerExceptionAllowExternalRequests {
        ...
        doRequest(request, response, requestUri, delegator);
    }

    public void doRequest(HttpServletRequest request, HttpServletResponse response, String chain, Delegator delegator) throws RequestHandlerException, RequestHandlerExceptionAllowExternalRequests {
...
//        }
        ...
        if ("request".equals(nextRequestResponse.type)) {
            ...
            doRequest(request, response, nextRequestResponse.value, delegator);
        } else {
            // ======== handle views ========
