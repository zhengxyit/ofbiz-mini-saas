...
public class CatalinaContainer implements Container {
    ...
    protected Map<String, Property> clusterConfig = new HashMap<String, Property>();
    ...
    public void init(String[] args, String name, String configFile) throws ContainerException {
        ...
        // create the engine
        List<Property> engineProps = cc.getPropertiesWithValue("engine");
        ...
        List<Property> connectorProps = cc.getPropertiesWithValue("connector");
    ...
    private Engine createEngine(Property engineConfig) throws ContainerException {
        if (tomcat == null) {
        ...
        if (UtilValidate.isNotEmpty(clusterProps)) {
            Property clusterProp = clusterProps.get(0);
    ...
    protected Cluster createCluster(Property clusterProps, Host host) throws ContainerException {
    ...
    protected Connector createConnector(Property connectorProp) throws ContainerException {
        if (tomcat == null) {
        ...
        if (UtilValidate.isNotEmpty(connectorProp.properties)) {
            ...
            for (Property prop: connectorProp.properties.values()) {
