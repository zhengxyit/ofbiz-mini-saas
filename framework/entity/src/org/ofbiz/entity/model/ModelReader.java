                            ...
                            while (relationsIter.hasNext()) {
                                ...
                                if (("one".equals(modelRelation.getType()) || "one-nofk".equals(modelRelation.getType())) && !modelRelation.isAutoRelation()) {
                                    ...
                                    if (relatedEnt != null) {
                                        ...
                                        ModelRelation newRel = ModelRelation.create(relatedEnt, description, type, title, relEntityName, fkName, keyMaps, curModelEntity.getSupportModules(), isAutoRelation);
