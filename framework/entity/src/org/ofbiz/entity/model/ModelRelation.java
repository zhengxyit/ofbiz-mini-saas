...
public final class ModelRelation extends ModelChild {
     ...
     */
    public static ModelRelation create(ModelEntity modelEntity, String description, String type, String title, String relEntityName, String fkName, List<ModelKeyMap> keyMaps, String supportModules, boolean isAutoRelation) {
        if (description == null) {
            description = "";
        }
        if (type == null) {
        ...
        return new ModelRelation(modelEntity, description, type, title, relEntityName, fkName, keyMaps, supportModules, isAutoRelation);
    }
    ...
    public static ModelRelation create(ModelEntity modelEntity, Element relationElement, boolean isAutoRelation) {
        ...
        String supportModules = UtilXml.childElementValue(relationElement, "support-modules");
    ...
    private boolean isSupportModules = false;

    private ModelRelation(ModelEntity modelEntity, String description, String type, String title, String relEntityName, String fkName, List<ModelKeyMap> keyMaps, String supportModules, boolean isAutoRelation) {
    ...
    public String getSupportModules() {
        return this.supportModules;
    }

    public boolean getIsSupportModules() {
        return this.isSupportModules;
    }
