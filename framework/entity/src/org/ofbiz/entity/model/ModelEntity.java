...
public class ModelEntity implements Comparable<ModelEntity>, Serializable {
    ...
    // 支持模块编码
    protected String supportModules = null;

    protected boolean isSupportModules = false;
    ...
    protected boolean isTenant = false;
    /**
    ...
    protected void populateBasicInfo(Element entityElement) {
        ...
        if (EntityUtil.isMultiTenantEnabled()) {
            this.isTenant = UtilXml.checkBoolean(entityElement.getAttribute("is-tenant"), false);
        }
        ...
        this.supportModules = entityElement.getAttribute("support-modules");
    ...
    public void addExtendEntity(ModelReader reader, Element extendEntityElement) {
        ...
        if (EntityUtil.isMultiTenantEnabled() && extendEntityElement.hasAttribute("is-tenant")) {
            this.isTenant = UtilXml.checkBoolean(extendEntityElement.getAttribute("is-tenant"), false);
        }
    ...
    public Element toXmlElement(Document document, String packageName) {
        ...
        if (this.getIsTenant()) {
            root.setAttribute("is-tenant", "true");
        }
