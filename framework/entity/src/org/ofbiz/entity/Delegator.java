...
public interface Delegator {
     ...
     *
     * @param entityName The Name of the Entity as defined in the entity XML file
     * @param fields     The fields of the named entity to query by with their
     ...
     *
     * @param value The GenericValue instance containing the new or existing
     *              instance
     ...
     *
     * @param entityName            The name of the Entity as defined in the entity XML file
     * @param whereEntityCondition  The EntityCondition object that specifies how to constrain
     *                              this query before any groupings are done (if this is a view
     *                              entity with group-by aliases)
     * @param havingEntityCondition The EntityCondition object that specifies how to constrain
     *                              this query after any groupings are done (if this is a view
     *                              entity with group-by aliases)
     * @param fieldsToSelect        The fields of the named entity to get from the database; if
     ...
     *                              descending
     * @param findOptions           An instance of EntityFindOptions that specifies advanced query
     ...
     * @param keys       The keys, or names, of the values to retrieve; only these
     ...
     * object, the the EntityCondition javadoc for more details.
     *
     * @param dynamicViewEntity     The DynamicViewEntity to use for the entity model for this
    ...
    String getEnterpriseModules();

    void setTenantId(String tenantId);

    void setEnterpriseModules(String supportModules);
     ...
     *
     * @param relationNameOne String containing the relation name which is the combination
     ...
     * @param orderBy         The fields of the named entity to order the query by; may be
     ...
     *
     * @param seqName    The name of the sequence to get the next seq id from
     * @param staggerMax The maximum amount to stagger the sequenced ID, if 1 the
     ...
     * store
     *
     * @param relationName String containing the relation name which is the combination
     *                     of relation.title and relation.rel-entity-name as specified in
     ...
     * transactions.
     *
     * @param dummyPKs Collection of GenericEntity instances containing the entities
     ...
     *
     * @param values List of GenericValue instances containing the entities to
     *               store
     * @return int representing number of rows effected by this operation
     */
     ...
     * GenericEntity on a create or store.
     *
     * @param storeOptions An instance of EntityStoreOptions that specifies advanced store
    ...
    boolean checkEnterpriseHasModules(String modules);
}
